...
export const initialTimeLogs: TimeLog[] = [
  ...
  },
  {
    ...
    userName: 'Oscar Cerpa',
    userInitials: 'OC',
    userAvatarBg: 'bg-[#f59e0b]',
...
export const initialUsers: UserItem[] = [
  ...
  },
  {
    ...
    officialRole: 'Client relationship',
  ...
  },
  {
    ...
    officialRole: 'Desarrollador Web Front-End',
  ...
  },
  {
    ...
    vacationStatus: {
      ...
      note: 'Vacaciones aprobadas. Regresa el 22 de Sep.'
    }
  },
  {
    id: 'u-12',
    ...
    capacityHours: 40,
    utilizedPercent: 86,
    jobTitle: 'Tracfiker y DigiOps',
    officialRole: 'Tracfiker y DigiOps',
  ...
  },
  {
    ...
    email: 'juancamilo@uhuragroup.com',
    initials: 'JT',
    avatarBg: 'bg-[#6366f1]',
    role: 'Member',
    status: 'Active',
  ...
  {
    id: 'u-18',
    name: 'Laura Viviana Salazar Perez',
